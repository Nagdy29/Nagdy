          ...
          <div className="flex justify-between flex-col xl:flex-row items-center xl:pt-8 xl:pb-24">
            <div className="text-center xl:text-left order-2 xl:order-none">
              ...
              <p className="max-w-[800px] mb-9 text-white/50">
                {" "}
           Frontend Developer (React.js) with 2+ year of hands-on experience building responsive, scalable web applications. Strong background in React, Tailwind CSS, JavaScript, and modern UI/UX practices. Experienced in integrating APIs, authentication, routing, and state management. Passionate about clean code, performance optimization, and delivering real-world production-ready projects.
              ...
              <div className="flex items-center flex-col xl:flex-row gap-5">
                <a
                  href="https://drive.google.com/file/d/1xIKsoUCVXZmX6lSkUwIsKaJgGIShpaRg/view?usp=drive_link"
                  target="_blank"
                >
